[@wago/wdx-schema](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Model](../modules/WDX.Schema.Model.md) / [Instance](../modules/WDX.Schema.Model.Instance.md) / AuthServerInstance
...
- [code](WDX.Schema.Model.Instance.AuthServerInstance.md#code)
- [createdDate](WDX.Schema.Model.Instance.AuthServerInstance.md#createddate)
- [cronOptions](WDX.Schema.Model.Instance.AuthServerInstance.md#cronoptions)
...
- [locale](WDX.Schema.Model.Instance.AuthServerInstance.md#locale)
...
- [options](WDX.Schema.Model.Instance.AuthServerInstance.md#options)
...
- [resourceUsage](WDX.Schema.Model.Instance.AuthServerInstance.md#resourceusage)
- [restartOptions](WDX.Schema.Model.Instance.AuthServerInstance.md#restartoptions)
...
- [uptime](WDX.Schema.Model.Instance.AuthServerInstance.md#uptime)
...
• **new AuthServerInstance**(`uuid?`, `name?`, `status?`, `executionOptions?`, `restartOptions?`, `cronOptions?`, `logOptions?`, `enabled?`, `processId?`, `parentProcessId?`, `threadId?`): [`AuthServerInstance`](WDX.Schema.Model.Instance.AuthServerInstance.md)
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/AuthServerInstance.ts:15
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/AuthServerInstance.ts:18
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/AuthServerInstance.ts:16

___

### options

• **options**: [`AuthServerOptions`](WDX.Schema.Model.Instance.AuthServerOptions.md)

#### Defined in

modules/wdx-schema/src/WDX/Schema/Model/Instance/AuthServerInstance.ts:17
