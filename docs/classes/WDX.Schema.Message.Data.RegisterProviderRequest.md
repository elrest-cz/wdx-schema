[@wago/wdx-schema](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Message](../modules/WDX.Schema.Message.md) / [Data](../modules/WDX.Schema.Message.Data.md) / RegisterProviderRequest
...
• **new RegisterProviderRequest**(`body?`, `uuid?`, `error?`, `topic?`, `target?`, `origin?`): [`RegisterProviderRequest`](WDX.Schema.Message.Data.RegisterProviderRequest.md)
...
modules/wdx-schema/src/WDX/Schema/Message/Data/RegisterProviderRequest.ts:15
...
modules/wdx-schema/src/WDX/Schema/Message/Data/RegisterProviderRequest.ts:13
