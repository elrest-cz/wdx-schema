[@wago/wdx-schema](../README.md) / [Exports](../modules.md) / [WDX](../modules/WDX.md) / [Schema](../modules/WDX.Schema.md) / [Model](../modules/WDX.Schema.Model.md) / [Instance](../modules/WDX.Schema.Model.Instance.md) / JSScriptInstance

# Class: JSScriptInstance

[Model](../modules/WDX.Schema.Model.md).[Instance](../modules/WDX.Schema.Model.Instance.md).JSScriptInstance
...
- [constructor](WDX.Schema.Model.Instance.JSScriptInstance.md#constructor)

### Properties

- [code](WDX.Schema.Model.Instance.JSScriptInstance.md#code)
- [createdDate](WDX.Schema.Model.Instance.JSScriptInstance.md#createddate)
- [cronOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#cronoptions)
- [dataSourceOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#datasourceoptions)
- [enabled](WDX.Schema.Model.Instance.JSScriptInstance.md#enabled)
- [executionOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#executionoptions)
- [locale](WDX.Schema.Model.Instance.JSScriptInstance.md#locale)
- [logOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#logoptions)
- [name](WDX.Schema.Model.Instance.JSScriptInstance.md#name)
- [namespace](WDX.Schema.Model.Instance.JSScriptInstance.md#namespace)
- [parentProcessId](WDX.Schema.Model.Instance.JSScriptInstance.md#parentprocessid)
- [processId](WDX.Schema.Model.Instance.JSScriptInstance.md#processid)
- [resourceUsage](WDX.Schema.Model.Instance.JSScriptInstance.md#resourceusage)
- [restartOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#restartoptions)
- [script](WDX.Schema.Model.Instance.JSScriptInstance.md#script)
- [status](WDX.Schema.Model.Instance.JSScriptInstance.md#status)
- [tcpOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#tcpoptions)
- [threadId](WDX.Schema.Model.Instance.JSScriptInstance.md#threadid)
- [udpOptions](WDX.Schema.Model.Instance.JSScriptInstance.md#udpoptions)
- [updatedDate](WDX.Schema.Model.Instance.JSScriptInstance.md#updateddate)
- [uptime](WDX.Schema.Model.Instance.JSScriptInstance.md#uptime)
- [uuid](WDX.Schema.Model.Instance.JSScriptInstance.md#uuid)

## Constructors

### constructor

• **new JSScriptInstance**(`uuid?`, `name?`, `status?`, `executionOptions?`, `restartOptions?`, `cronOptions?`, `logOptions?`, `enabled?`, `processId?`, `parentProcessId?`, `threadId?`): [`JSScriptInstance`](WDX.Schema.Model.Instance.JSScriptInstance.md)
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/JSScriptInstance.ts:16
...
• **executionOptions**: [`JSScriptExecutionOptions`](WDX.Schema.Model.Instance.JSScriptExecutionOptions.md)
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/JSScriptInstance.ts:19
...
• **namespace**: `string` = `Type.JSScript`
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/JSScriptInstance.ts:17
...
modules/wdx-schema/src/WDX/Schema/Model/Instance/JSScriptInstance.ts:18
